...
void showHelp(const std::vector<std::string> &args)
{
    ...
    std::cout << std::setw(20) << "bookmark" << ": Bookmark management" << std::endl;
    std::cout << std::setw(20) << "--------------------" << "--------------------" << std::endl;
    ...
    std::cout << std::setw(20) << "ronaldo" << ": Sundaythekingplays" << std::endl;
    std::cout << std::setw(20) << "run_producer_consumer" << ": Run producer-consumer <num_of_producer> <num_of_consumer> <product_by_producer> <size_of_buffer>" << std::endl;
